...
namespace PrancingPonySharp.Try
{
        ...
        where TE4 : Exception
    {
        ...
        /// </summary>
        public T RunOrFailureHandle(Func<TE1, T> case1, Func<TE2, T> case2, Func<TE3, T> case3, Func<TE4, T> case4, Func<Exception, T> caseDefault)
        {
            try
            {
                return Function();
        ...
        /// </summary>
        public void RunOrFailureHandle(Action<TE1> case1, Action<TE2> case2, Action<TE3> case3, Action<TE4> case4, Action<Exception> caseException)
        {
            try
            {
                Function();
